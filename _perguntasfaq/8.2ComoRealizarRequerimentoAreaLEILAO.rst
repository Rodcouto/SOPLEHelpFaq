...
1. Gerar a GRU (Guia de Recolhimento da União) com o valor do lance vencedor e realizar o pagamento dentro do prazo definido no Edital da Rodada:
...
4. Protocolizar o requerimento no Protocolo Digital da ANM:
	...
	4.2 Utilizar o login e senha associado ao CPF/CNPJ da pessoa que arrematou a área no GOV.BR;
	
	4.3 Informar o Código do Requerimento - Deve ser o mesmo informado no requerimento do passo 3;
	
	4.4 Anexar os documentos complementares e informar, no campo “Informe o número do nosso boleto”, os dados do boleto do emolumento do requerimento de autorização de pesquisa, não esquecendo de anexar o comprovante do pagamento tanto do emolumento, bem como o comprovante de pagamento quanto do lance vencedor.
