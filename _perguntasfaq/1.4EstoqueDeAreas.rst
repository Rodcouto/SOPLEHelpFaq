...
**Aviso: ** A ANM não se responsabiliza pelo uso inadequado das informações contidas na ferramenta Geopotencial. Para maiores informações sobre os estudos que originaram os dados disponíveis, sugerimos consultar o Portal GEOSGB (https://geosgb.sgb.gov.br/home.html).
